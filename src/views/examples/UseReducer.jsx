...
import { numberAdd2, login, resetLogin } from '../../store/actions'
        ...
        <div className="UseReducer">
            ...
            <div className="center">
                ...
                <div>
                    ...
                    <button className="btn"
                    onClick={()=> resetLogin(dispatch, 'user')}>Reset Login</button>
                    <button className="btn"
                    ...
                    <button className="btn"
                    onClick={() => dispatch({type: 'numberAddN', payload: -6})}>N</button>
                </div>
            </div>
        </div>
    )
